  ...
  return (
    ...
    >
      <button
        ...
        className="flex items-center gap-2 rounded-md bg-gray-100 px-3 py-1.5 text-sm font-medium text-gray-800 transition-colors hover:bg-gray-200 focus:outline-none"
      ...
      {isOpen && (
        <div
          className={`absolute mt-2 w-32 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-gray-200 focus:outline-none ${dir === "ltr" ? "right-0" : "left-0"}`}
          role="menu"
          id="language-menu"
        ...
        >
          {LANGUAGE_CODES.map((lang, index) => (
            <button
              ...
              className={`block w-full rounded-md px-4 py-2 text-left text-sm transition-colors hover:bg-gray-100 ${
