          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>{t("homePage.features.multilanguageStrong")}</strong>
                  <p className="text-gray-700">
            ...
            <div className="p-4 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>{t("homePage.features.accessibilityStrong")}</strong>
                  <p className="text-gray-700">
            ...
            <div className="p-4 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>{t("homePage.features.notificationsStrong")}</strong>
                  <p className="text-gray-700">
